...
class Dbms(models.Model):
    ...
    avatar = fields.Image(related='name.avatar', string="avatar", readonly=True)
    ...
    weapon_stat = fields.Many2one('genshin.impact.weapons', string='Pasiva')
    ...
    char_art_flower_stat1 = fields.Float(string='Stat 1', default="1", tracking=True)
    char_art_flower_stat2 = fields.Float(string='Stat 2', default="1", tracking=True)
    char_art_flower_stat3 = fields.Float(string='Stat 3', default="1", tracking=True)
    char_art_flower_stat4 = fields.Float(string='Stat 4', default="1", tracking=True)
    char_art_flower_sub1 = fields.Selection(ART_STAT_TYPES, string='Sub 1', tracking=True)
    char_art_flower_sub2 = fields.Selection(ART_STAT_TYPES, string='Sub 2', tracking=True)
    char_art_flower_sub3 = fields.Selection(ART_STAT_TYPES, string='Sub 3', tracking=True)
    char_art_flower_sub4 = fields.Selection(ART_STAT_TYPES, string='Sub 4', tracking=True)
    ...
    char_art_plume_stat1 = fields.Selection(ART_STAT_TYPES, string='Sub 1', default="1", tracking=True)
    ...
    char_art_globlet = fields.Many2one('genshin.impact.artifacts', string='Cáliz de Eonothem', tracking=True)
    char_art_globlet_rarity = fields.Selection(RARITY, string='Rareza (Cáliz)', tracking=True)
    char_art_globlet_level = fields.Integer(string='Nivel', default="1", tracking=True)
    char_art_globlet_stat1 = fields.Float(string='Stat 1', default="1", tracking=True)
    char_art_globlet_stat2 = fields.Float(string='Stat 2', default="1", tracking=True)
    char_art_globlet_stat3 = fields.Float(string='Stat 3', default="1", tracking=True)
    char_art_globlet_stat4 = fields.Float(string='Stat 4', default="1", tracking=True)
    char_art_globlet_sub1 = fields.Selection(ART_STAT_TYPES, string='Sub 1', tracking=True)
    char_art_globlet_sub2 = fields.Selection(ART_STAT_TYPES, string='Sub 2', tracking=True)
    char_art_globlet_sub3 = fields.Selection(ART_STAT_TYPES, string='Sub 3', tracking=True)
    char_art_globlet_sub4 = fields.Selection(ART_STAT_TYPES, string='Sub 4', tracking=True)
    ...
    art_2pza_passive = fields.Many2one('genshin.impact.artifacts.sets', string='Bonus 2 Piezas')
    art_4pza_passive = fields.Many2one('genshin.impact.artifacts.sets', string='Bonus 4 Piezas')
