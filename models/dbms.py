...
class Dbms(models.Model):
    ...
    avatar = fields.Image(string='Avatar', related='characters_name.avatar')
    full_avatar = fields.Image(string='Avatar', related='characters_name.full.avatar')
    name = fields.Many2one('genshin.impact.characters', string="Nombre")
    element = fields.Integer(string='Elemento', related='characters_name.element')
    weapon_type = fields.Integer(string='Tipo de Arma', related='characters_name.weapon_type')
