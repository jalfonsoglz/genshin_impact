...
class Dbms(models.Model):
    ...
    weapon_note = fields.Many2one('genshin.impact.weapons', related='weapons.note', string='Efecto')
    weapon_atk = fields.Integer(string='Ataque', default="1", tracking=True)
    weapon_stat = fields.Many2one('genshin.impact.weapons', related='weapons.weapon_sub_stat_type', string='Sub Status')
